	...
	<nav class="navbar navbar-expand">
		...
		<div class="user-box dropdown" style="padding-left: 20px">
			...
			<ul class="dropdown-menu dropdown-menu-end">
				...
				<li>
					<a class="dropdown-item" href=""><i class="bx bx-repost"></i><span>Reset password</span></a>
				</li>
				<li>
					<a class="dropdown-item" href="{{asset('')}}"><i class='bx bx-home-circle'></i><span>Home</span></a>
				</li>
				<li>
					<div class="dropdown-divider mb-0"></div>
				</li>
				<li>
					<a class="dropdown-item" href="/admin/logout"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
				</li>
			</ul>
		</div>
